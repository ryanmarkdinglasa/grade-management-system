								...
								<?php
									try {
										...
										foreach ($subjects as $subject) {
											...
											if (!empty($isgraded['isPrelim'])) {
												$prelim_grade++;
											}
											if (!empty($isgraded['isMidterm'])) {
												$midterm_grade++;
											}
											if (!empty($isgraded['isFinal'])) {
												$final_grade++;
											}
										}
									} catch (Exception $e) {
									...
									<?php if (!empty($link)): ?>
										<a href="<?php echo $link; ?>" class="btn btn-primary text-white btn-sm"><i class="fa fa-eye"></i> <?php echo $label; ?></a>
									<?php else: ?>
										<a href="#" class="btn btn-primary text-white btn-sm disabled"><i class="fa fa-eye"></i> No Grades</a>
									<?php endif; ?>
