              ...
              <?php
                try {
                    ...
                    if ($result) {
                        ...
                        echo "No active period found."; // Handle the case when no active period is found.
                    }
                
                } catch (PDOException $e) {
                    // Handle the exception or error (e.g., log the error, display a user-friendly message).
