        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              ?>
              <li class="nav-item">
              <a class="nav-link <?php echo ($page  == "Student" ? "active" : "") ?>" href="#navbar-account" data-toggle="collapse" role="button" aria-expanded="<?php echo ($page == "Student" ? "true" : "false") ?>" aria-controls="navbar-dataaccount">
                <i class="ni ni-hat-3 text-primary"></i>
                <span class="nav-link-text">Student</span>
              </a>
              <div class="collapse <?php echo ($page == "Student" ? "show" : "") ?>" id="navbar-account">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="student_list.php" class="nav-link  <?php echo ($childpage == "Student" ? "active" : "") ?>">Student List</a>
                  </li>
                  <li class="nav-item">
                    <a href="print_list.php" class="nav-link <?php echo ($childpage == "Print" ? "active" : "") ?>">Print List</a>
                  </li>
                </ul>
              </div>
            </li>
              ...
              ?>
            <li class="nav-item">
              <a class="nav-link <?php echo ($page == "Class" ? "active" : "") ?>" href="class.php">
            ...
            <?php
              ...
              ?>
              <a class="nav-link <?php echo ($page == "Class" ? "active" : "") ?>" href="class_course.php">
                <i class="ni ni-folder-17  text-primary"></i>
                <span class="nav-link-text">Class</span>
              </a>
              <?php
            ...
            <?php
              ...
              ?>
              <li class="nav-item">
                <a class="nav-link <?php echo ($page == "Grade" ? "active" : "") ?>" href="grade.php">
            ...
            <?php
              ...
              ?>
                <li class="nav-item">
                  <a class="nav-link <?php echo ($page == "Grade" ? "active" : "") ?>" href="grading_sheet.php">
                    <i class="ni ni-archive-2  text-primary"></i>
                    <span class="nav-link-text">Grading Sheet</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?php echo ($page == "Grades" ? "active" : "") ?>" href="grades.php">
                    <i class="ni ni-archive-2  text-primary"></i>
            ...
            <?php
              ...
              ?>
            <li class="nav-item">
              <a class="nav-link <?php echo ($page == "Course" ? "active" : "") ?>" href="course.php">
              ...
              ?>
              <li class="nav-item">
                <a class="nav-link <?php echo ($page == "Course" ? "active" : "") ?>" href="course_schedule.php">
                  <i class="ni ni-books text-primary"></i>
                  <span class="nav-link-text">Course</span>
                </a>
              </li>
