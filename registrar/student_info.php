                            ...
                            <?php
                               ...
                               // Access the fetched data by key
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="border:1px solid red;">
                                        <div class="form-group">
                                            <label class="form-control-label" for="">No. of Siblings:</label><br>
                                            <label class="form-control-label text-muted" for="">
                                                <?php 
                                                 $siblings =($application_data['siblings']=='')?'None':$application_data['siblings'];
                                                echo $siblings;
                                                ?></label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3" style="border:1px solid red;">
                                        <div class="form-group">
                                            <label class="form-control-label" for="">Guardian's Name:</label><br>
                                            <label class="form-control-label text-muted" for="">
                                                <?php 
                                                 $guardian_name =($application_data['guardian_name']=='')?'None':$application_data['guardian_name'];
                                                echo $guardian_name;
                                                ?></label>
                                        </div>
                                    </div>
                                    <div class="col-md-3" style="border:1px solid red;">
                                        <div class="form-group">
                                            ...
                                            <label class="form-control-label text-muted" for="">
                                                <?php 
                                                 $guardian_email =($application_data['guardian_email']=='')?'None':$application_data['guardian_email'];
                                                echo $guardian_email;
                                                ?></label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" style="width:500px;height:700px;">
                                    <div class="container">
                                        <div class="row py-2">
                                            ...
                                            <div class="col-md-12 media">
                                                <a href="img/<?php echo $application_data['picture'];?>" target="_blank" data-toggle="lightbox" data-gallery="gallery" data-max-width="100%" data-max-height="100%">
                                                <img src="img/<?php echo $application_data['picture'];?>" alt="requirement" class="img-fluid application-requirement" style="width:200px;height:200px; border:1px solid grey;">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container">
                                        <div class="row py-2">
                                            ...
                                            <div class="col-md-12 media">
                                                <a href="img/<?php echo $application_data['signature'];?>" target="_blank" data-toggle="lightbox" data-gallery="gallery" data-max-width="100%" data-max-height="100%">
                                                <img src="img/<?php echo $application_data['signature'];?>" alt="requirement" class="img-fluid application-requirement" style="width:200px;height:200px; border:1px solid grey;">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
