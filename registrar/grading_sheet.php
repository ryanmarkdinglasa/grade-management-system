<?php
  //error_reporting(0);
	...
	$parentpage = "Records";
	$parentpage_link= "#";
	$currentpage='Grading Sheet';
	$childpage = "Grading Sheet";
  $content_right='';
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <div class="row">
                <div class="col-8">
                  <h3 class="mb-3 ">Grading Sheet</h3>
                </div>
            ...
            <div class="table-responsive">
              <div class="card-body">
                <form action="grading_sheet_print.php" method="POST" id="myForm" target="_blank">
                  <div class="row">
                    ...
                    <div class="col-lg-3" style="">
                      <label class="form-control-label"> Action</label><br>
                          <button type="submit"  id="print" name="print"  class="btn bg-green text-primary font-weight-bolder">
