            ...
            <div class="card mb-4">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <!-- Title -->
                            <h3 class="mb-0 text-primary font-weight-bolder">Student Information</h3>
                        </div>
                        <div class="col-4 text-right mb-0">
                            <form>
                                    <a href="student_print.php?id=<?php echo $_GET['id'];?>" target="_blank" id="approve" name="approve" class="text-primary btn btn-icon bg-green font-weight-bolder my-4"  type="button">
                                            <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
