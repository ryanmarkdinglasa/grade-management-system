			  ...
			  <div class="container-fluid">
				<div class="header-body">
							...
							<div class="card card2 card-stats">
								<div class="card-body">
									<div class="row">
										<div class="col">
											<h1>
												<svg style=""xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M243.4 2.6l-224 96c-14 6-21.8 21-18.7 35.8S16.8 160 32 160v8c0 13.3 10.7 24 24 24H456c13.3 0 24-10.7 24-24v-8c15.2 0 28.3-10.7 31.3-25.6s-4.8-29.9-18.7-35.8l-224-96c-8-3.4-17.2-3.4-25.2 0zM128 224H64V420.3c-.6 .3-1.2 .7-1.8 1.1l-48 32c-11.7 7.8-17 22.4-12.9 35.9S17.9 512 32 512H480c14.1 0 26.5-9.2 30.6-22.7s-1.1-28.1-12.9-35.9l-48-32c-.6-.4-1.2-.7-1.8-1.1V224H384V416H344V224H280V416H232V224H168V416H128V224zM256 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
												<?php 
													/*
				  ...
				  <div class="row">
					...
					<div class="col-xl-4 col-md-4 cursor-pointer" onclick="window.location.href='faculty.php'">
					  <button class="card card-stats bg-green w-100 text-left"  >
						<div class="card-body w-100">
						  <div class="row ">
							<div class="col">
							  	<h5 class="card-title text-uppercase mb-0  "> faculty </h5>
							...
							<div class="col-auto">
							  	<div class=" " style="">
							  		<svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="5rem" viewBox="0 0 640 512"><path d="M192 96a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm-8 384V352h16V480c0 17.7 14.3 32 32 32s32-14.3 32-32V192h56 64 16c17.7 0 32-14.3 32-32s-14.3-32-32-32H384V64H576V256H384V224H320v48c0 26.5 21.5 48 48 48H592c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48H368c-26.5 0-48 21.5-48 48v80H243.1 177.1c-33.7 0-64.9 17.7-82.3 46.6l-58.3 97c-9.1 15.1-4.2 34.8 10.9 43.9s34.8 4.2 43.9-10.9L120 256.9V480c0 17.7 14.3 32 32 32s32-14.3 32-32z"/></svg>
								</div>
							</div>
						  </div>
						   <p class="mt-3 mb-0 text-sm">
							<span class="text-primary">Total Faculty</span>
						  </p> 
						</div>
						</button>
					</div>
					<div class="col-xl-4 col-md-4  cursor-pointer" onclick="window.location.href='student.php'">
					  <button class="card card-stats bg-green w-100 text-left"  >
						<div class="card-body w-100">
						  <div class="row ">
							<div class="col">
							  	...
							  	<span class="h2 font-weight-bold mb-0"> 
								<?php
									$query= "SELECT * FROM `student` INNER JOIN `program` ON `program`.`Id`=`student`.`program_id` WHERE `program`.`institute_id`='".$user['institute_id']."'";
									$stmt =$con->prepare($query);
									$stmt -> execute();
									$count =$stmt->rowCount();
									echo"".$count;
							...
							<div class="col-auto">
							  	<div class=" " style="">
								  	<svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="5rem" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M320 32c-8.1 0-16.1 1.4-23.7 4.1L15.8 137.4C6.3 140.9 0 149.9 0 160s6.3 19.1 15.8 22.6l57.9 20.9C57.3 229.3 48 259.8 48 291.9v28.1c0 28.4-10.8 57.7-22.3 80.8c-6.5 13-13.9 25.8-22.5 37.6C0 442.7-.9 448.3 .9 453.4s6 8.9 11.2 10.2l64 16c4.2 1.1 8.7 .3 12.4-2s6.3-6.1 7.1-10.4c8.6-42.8 4.3-81.2-2.1-108.7C90.3 344.3 86 329.8 80 316.5V291.9c0-30.2 10.2-58.7 27.9-81.5c12.9-15.5 29.6-28 49.2-35.7l157-61.7c8.2-3.2 17.5 .8 20.7 9s-.8 17.5-9 20.7l-157 61.7c-12.4 4.9-23.3 12.4-32.2 21.6l159.6 57.6c7.6 2.7 15.6 4.1 23.7 4.1s16.1-1.4 23.7-4.1L624.2 182.6c9.5-3.4 15.8-12.5 15.8-22.6s-6.3-19.1-15.8-22.6L343.7 36.1C336.1 33.4 328.1 32 320 32zM128 408c0 35.3 86 72 192 72s192-36.7 192-72L496.7 262.6 354.5 314c-11.1 4-22.8 6-34.5 6s-23.5-2-34.5-6L143.3 262.6 128 408z"/></svg>
							  	</div>
							</div>
						  </div>
						   <p class="mt-3 mb-0 text-sm">
							<span class="text-primary">Total Student</span>
						  </p> 
						</div>
						</button>
					</div>
					<div class="col-xl-4 col-md-4  cursor-pointer" onclick="window.location.href='course.php'">
					  <button class="card card-stats bg-green w-100 text-left"  >
						<div class="card-body w-100">
						  <div class="row ">
							<div class="col">
							  	<h5 class="card-title text-uppercase mb-0  "> course </h5>
							  	<span class="h2 font-weight-bold mb-0"> 
								  <?php
					...
					?>
					<div class="col-xl-6 col-md-6 cursor-pointer" onclick="window.location.href='student_list.php'">
					  <button class="card card-stats bg-green w-100 text-left"  >
						<div class="card-body w-100">
						  <div class="row ">
							<div class="col">
						   ...
						   <p class="mt-3 mb-0 text-sm">
							<span class="text-primary">Total students</span>
						  </p> 
						</div>
						</button>
					</div>
					<div class="col-xl-6 col-md-6 cursor-pointer" onclick="window.location.href='class_course.php'">
					  <button class="card card-stats bg-green w-100 text-left"  >
						<div class="card-body w-100">
						  <div class="row ">
							<div class="col">
							  	<h5 class="card-title text-uppercase mb-0  "> Class </h5>
							  	<span class="h2 font-weight-bold mb-0"> 
								<?php
									$query2= "SELECT 
						   ...
						   <p class="mt-3 mb-0 text-sm">
							<span class="text-primary">Total handled students</span>
						  </p> 
						</div>
						</button>
					</div> <?php } ?>
						...
						<div class="card">
						  <div class="card-header">
							...
							<?php $userphoto = $row['user_image'];
								if ($userphoto == "" || $userphoto == "NULL")  echo' <img src="img/profile.png" class="avatar rounded-circle mr-3">';
								else echo'<img src="../'.$row['user_type'].'/img/'.htmlentities($userphoto).'" class="avatar rounded-circle mr-3">';
								//Posted By & Posted On
