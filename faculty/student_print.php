                                ...
                                <table class="" 
                                    ...
                                    <tr>
                                        <td rowspan="5" style="text-align:right;">
                                            <img src="../registrar/img/favicon.png" alt="requirement" class="img-fluid application-requirement" style="width:50px;height:50px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td rowspan="6" colspan="2" style="">
                                                <img src="../registrar/img/<?php echo $application_data['picture'];?>" alt="requirement" class="img-fluid application-requirement" style="width:150px;height:150px; border:1px solid grey;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <img src="../registrar/img/<?php echo $application_data['signature'];?>" alt="signature" class="img-fluid application-requirement" style="width:150px;height:50px;">
