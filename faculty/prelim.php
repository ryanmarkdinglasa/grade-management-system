<?php
	...
	$parentpage='Grading Sheet';
	$parentpage_link='grading_sheet.php';
	$page='Prelim|Grade Sheet Encoding';
	$currentpage='Grade';
	$content_right='';$schedule=[];$class=[];$get=[];
	//validate user
					...
					<div class="table-responsive">
						...
						<tbody>
					  	...
					  	<div class="text-right">
							...
							<button type="submit" id="prelim" name="prelim" class="add btn bg-green text-primary font-weight-bolder  my-4 w-10" style="margin-right:25px;">Submit</button>
						</div>
						</form>
					</div>
				</div>
