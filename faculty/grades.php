							...
							<form action="" method="POST">
								<div class="row">
									...
									<div class="col-lg-3" style="">
										...
										<button type="submit "  id="view" name="view"  class="btn bg-green text-primary text-primary font-weight-bolder">
											<i class="fa fa-eye text-priamry"></i>
											View
										</button>
									</div>
								</div>
										...
										foreach($students as $student){
											...
											<td>
												...
												if (is_numeric($grade_final)) {
													...
													if ($numericGrade < 75 && $numericGrade >= 50) { $note = 'FAILED'; } 
													else if ($numericGrade >= 75 && $numericGrade <= 100) { $note = 'PASSED'; }
												} else {
													if ($grade_final == 'UD') { $note = 'UD'; } 
													else if ($grade_final == 'OD') { $note = 'OD'; } 
													else if ($grade_final == 'INC') { $note = 'INC'; }
