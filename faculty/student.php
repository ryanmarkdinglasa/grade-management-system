        ...
        <div class="col">
          <div class="card">
            <div class="card-header border-0">
              <div class="row">
                <div class="col-6">
                  <h3 class="mb-0 font-weight-bolder text-primary">Student List</h3>
                </div>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a class="btn bg-green btn-sm text-primary" href="student_info.php?id=<?php echo $row['student_id']?>" ><i class="fas fa-eye" ></i> View more</a>
                      </td>
                    </tr>
                  <?php 
                  } //while
