        ...
        <div class="col">
          <div class="card">
            <div class="card-header border-0">   <!-- Card header -->
              <div class="row">
                <div class="col-6">
                  <h3 class="mb-0 text-primary font-weight-bolder">Administrator</h3>
                </div>
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <?php $status = $row['status'];
                              if ($status > 0) :
                              ?>
                              <a class="dropdown-item" href="admin_controller.php?id=<?php echo $row['id'] ?>&off=0"><i class="fas fa-lock text-primary "></i> Deactivate Account</a>
                              <?php else : ?>
                              <a class="dropdown-item" href="admin_controller.php?id=<?php echo $row['id'] ?>&on=1"><i class="fas fa-lock-open text-primary " ></i> Activate Account</span></a>
                            <?php endif; ?>
                            <a class="dropdown-item" href="admin_controller.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to remove admin, <?php echo htmlentities($row['username']); ?> ?')"><i class="fas fa-trash text-primary "></i> Delete Account</a>
                          </div>
                        </div>
                      </td>
