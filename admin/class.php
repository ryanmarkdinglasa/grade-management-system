											...
											<div class="card bg-blue border-0 mb-0">
												<div class="card-body px-lg-5 py-lg-5">
													...
													<form role="form" method="post" action="class_controller.php">
														...
														<?php $edit_period=getrecord('period',['status'],['1']); ?>
														...
														<div class="text-right">
															<button type="reset" id="cancel-button<?php echo $row['class_id'];?>" class="btn btn-primary my-4 sp-add bg-secondary text-primary font-weight-bolder" >Cancel</button>
